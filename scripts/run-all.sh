...
echo ""
echo "Terminal 2 — Forensic Agent:"
echo "  cd agents && AGENT_TRANSPORT=${MODE} pnpm forensic"
echo ""
echo "Terminal 3 — Analysis Agent:"
echo "  cd agents && AGENT_TRANSPORT=${MODE} pnpm analysis"
echo ""
echo "Terminal 4 — Verification Agent:"
echo "  cd agents && AGENT_TRANSPORT=${MODE} pnpm verification"
echo ""
